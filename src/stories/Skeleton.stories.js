...
export const Rect = {
  name: 'Rect',
  args: { w: '240px', h: '20px', id: 'skel-1', 'data-testid': 'skel', m: '0', skeletonStartColor: '#f3f4f6', skeletonMidColor: '#e5e7eb', skeletonEndColor: '#f3f4f6' },
  argTypes: {
...
export const Circle = {
  name: 'Circle',
  args: { circle: true, w: '64px', h: '64px', skeletonStartColor: '#f3f4f6', skeletonMidColor: '#e5e7eb', skeletonEndColor: '#f3f4f6' },
  render: (args) => React.createElement(Skeleton, { ...args }),
};
