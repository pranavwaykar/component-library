...
export const TextInput = ({
  ...
  disabled = false,
  loading = false,
  /* removed props: size, shadow, elevation */
  ...rest
}) => {
  ...
  // Move dimension-related props to the input itself (and its immediate wrapper) instead of outer container
  dimKeys.forEach((k) => {
...
export const DateRange = ({
  ...
  function pickMonth(monthIndex, year) {
    ...
    monthIndex && monthIndex > 0 ? monthIndex = monthIndex + 1 : monthIndex = 0;
